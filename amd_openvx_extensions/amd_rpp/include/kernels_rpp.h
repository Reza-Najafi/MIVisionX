...
// VX_KERNEL_RPP_COLORTWISTBATCHPS = VX_KERNEL_BASE(VX_ID_AMD, VX_LIBRARY_RPP) +0x123,
// VX_KERNEL_RPP_COLORTWISTBATCHPDROID = VX_KERNEL_BASE(VX_ID_AMD, VX_LIBRARY_RPP) +0x125,
